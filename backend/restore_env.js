...
NODE_ENV=production
MONGODB_URI=mongodb+srv://venkeyy8180_db_user:venkeyy8180@cluster0.tzuuknm.mongodb.net/aspirebridge?retryWrites=true&w=majority
...
console.log('✅ .env restored to original remote database');
